  ...
  return (
    ...
    <div className="px-4">
      <div className="py-4 flex items-center justify-between ">
        ...
        <div className="border border-white border-opacity-30 h-10 w-10 inline-flex items-center justify-center rounded-lg cursor-pointer sm:hidden">
          <MenuIcon className="text-white" />
        </div>
        <nav className="gap-6 items-center hidden sm:flex">
          <a href="" className="text-opacity-60 text-white hover:text-opacity-100 hover:text-green-300 transition">About</a>
          ...
          <button className="bg-white py-2 px-4 rounded-lg font-bold">Get for free</button>
        </nav>
      </div>
    </div>
    </div>
